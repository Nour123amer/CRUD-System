...
function displayProducts() {
    ...
    <tr>
                    ...
                    <td><img width="100px" src=${productList[i].image} alt=""></td>
                    <td>
                        <button type="button" onclick="liftingValuesToInputs(${i})" class="btn btn-outline-warning btn-sm">Update</button>
                        <button type="button" onclick="deleteProduct(${i})" class="btn btn-outline-danger btn-sm">Delete</button>
                    </td>
                </tr>
    `
...
function liftingValuesToInputs(indexElement) {
...
function updateProduct() {
    var productValues = {
        ...
        category: productCategory.value,
        description: productDescription.value,
        image: productImage.files[0]?.name?`images/products/${productImage.files[0]?.name}`:`images/products/bg.jpeg`
    };
